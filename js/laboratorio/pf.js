...
<section class="card scroll-horizontal">
        ...
        item.onclick = ()=> agregar(item.classList[1]);
        });
        ...
        fila.innerHTML = `
            ...
            document.querySelector(`.edit_${licencia.id}`).onclick = ()=> editarElemento(licencia.id,'licencia');
            document.querySelector(`.delete_${licencia.id}`).onclick = ()=> deleteElemento(licencia.id,'licencia');             
        });
        ...
        <td><img src="./assets/icons/editar.svg" class="edit_${item.id}"></img></td>
            ...
            document.querySelector(`.edit_${item.id}`).onclick = ()=> editarElemento(item.id,'fuente');
            document.querySelector(`.delete_${item.id}`).onclick = ()=> deleteElemento(item.id,'fuente');             
        });
        ...
        document.querySelector(`.edit_${item.id}`).onclick = ()=> editarElemento(item.id,'equipo');
        document.querySelector(`.delete_${item.id}`).onclick = ()=> deleteElemento(item.id,'equipo');             
        });
        ...
        document.querySelector(`.edit_${item.id}`).onclick = ()=> editarElemento(item.id,'detector');
        document.querySelector(`.delete_${item.id}`).onclick = ()=> deleteElemento(item.id,'detector');             
        });
        ...
        document.querySelector(`.edit_${item.id}`).onclick = ()=> editarElemento(item.id,'personal');
        document.querySelector(`.delete_${item.id}`).onclick = ()=> deleteElemento(item.id,'personal');             
        });
